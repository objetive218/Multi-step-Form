...
const Navbar = ({select}) => {
    return (
        <nav className='navBar'>
            <img className='desktop' src="src\assets\images\bg-sidebar-desktop.svg" alt="desktop" />
            <img className='mobile' src="src\assets\images\bg-sidebar-mobile.svg" alt="mobile" />
            <ul>
                <li>
